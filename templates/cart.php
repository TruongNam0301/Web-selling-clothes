			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action='' enctype="multipart/form-data" id='form-buy' method='post' name="form-buy">
						<input id='total' name='total' type='hidden'><br>
						<label>SDT:</label> <input id='sdt' name='sdt' onkeypress="return isNumberKey(event)" type='text'><br>
						<label>Dia Chi:</label> <input id='address' name='address' type='text'><br>
